...
function Signup() {
    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (event) => {
        ...
        // Here you can perform further actions like sending the data to a server
            ...
            const response = await axios.post('http://localhost:9764/auth/signup', formData);
  ...
  return (
    <div><div class="wrappe bg-secondary">
                                ...
                                <div class="form-body">
                                    <form class="row g-3" onSubmit={handleSubmit}>
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="firstName"            value={formData.firstName}onChange={handleInputChange}  class="form-control" id="inputFirstName" placeholder="Jhon"/>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="inputLastName" class="form-label">Last Name</label>
                                            <input type="text" name='lastName' value={formData.lastName}onChange={handleInputChange} class="form-control" id="inputLastName" placeholder="Deo"/>
                                        </div>
                                        <div class="col-12">
                                            <label for="inputEmailAddress" class="form-label">Email Address</label>
                                            <input type="email"value={formData.emailAddress}onChange={handleInputChange}  name='emailAddress' class="form-control" id="inputEmailAddress" placeholder="example@user.com"/>
                                        </div>
                                        <div class="col-12">
                                            <label for="inputChoosePassword" class="form-label">Password</label>
                                            <div class="input-group" id="show_hide_password">

                                                <input type="password" value={formData.password}onChange={handleInputChange}  name="password" class="form-control border-end-0" id="inputChoosePassword"  placeholder="Enter Password"/> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
                                            
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label for="inputSelectCountry" class="form-label">Country</label>
                                            <select class="form-select" value={formData.country}onChange={handleInputChange} name='country' id="inputSelectCountry" aria-label="Default select example">
                                        ...
                                        <div class="col-12">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" value={formData.username}onChange={handleInputChange} name="agreeToTerms" type="checkbox" id=""/>
